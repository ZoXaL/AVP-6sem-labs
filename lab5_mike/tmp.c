...
int main(int argc,char *argv[])
{
	...
	cl_mem matrix_buffer = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_USE_HOST_PTR, MATRIX_SIZE_BYTES, source_matrix, NULL);
    //const char *filename="MemoryModel.cl";
    const char *filename="memset.cl";
    string sourceStr;
    ...
    clSetKernelArg(kernel,0,sizeof(MATRIX_SIZE_BYTES),(void *)&matrix_buffer);
